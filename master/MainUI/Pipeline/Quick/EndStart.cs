...
{
    public partial class EndStart : Form
    {
        bool isWork = false;
        ...
        private void DIgrp_KeyValueChange(object sender, DIValueChangedEventArgs e)
        {
            ...
            if (e.Key == "预热水泵主接检测")
            {
                if (e.Value)
                {
                    ...
                    this.uiLight13.State = UILightState.On;
                    this.uiLight14.State = UILightState.Off;
                }
                else
                {
                    this.uiLight9.State = UILightState.Off;
                    this.uiLight10.State = UILightState.On;
                    this.uiLight13.State = UILightState.Off;
                    this.uiLight14.State = UILightState.On;
                }
            }
            if (e.Key == "预供机油泵合闸检测")
            {
        ...
        {
            "90","91","92","93","95","96","97","100","115","39"
        };
