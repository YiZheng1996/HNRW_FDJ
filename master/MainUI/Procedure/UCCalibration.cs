...
namespace MainUI.Procedure
{
    ...
    public partial class UCCalibration : UserControl, IIndexValue
    {
        ...
        //    set
        //    {
        //        raw = value / Math.Pow(10, this.Radix);
        //        OnBaseValueChanged(raw);
        //        //SetActual();
        //    }
        //}
        ...
        private SectionNameTypes nameTypes = SectionNameTypes.Custom;
        /// <summary>
        /// 配置文件的名称组合方式
        /// </summary>
        [DefaultValue(SectionNameTypes.Custom)]
        ...
        protected virtual void OnSubmits(object sender, SubmitArgs e)
        {
            ...
            if (Submited != null) Submited(sender, e);
        }
