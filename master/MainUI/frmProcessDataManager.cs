...
namespace MainUI
{
    public partial class frmProcessDataManager : Form
    {
        TestRecordBLL mTestRecord = new TestRecordBLL();

        Excel._Worksheet sheet = null;
        public frmProcessDataManager()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        private void Init()
        {
            try
            {
                ...
                this.dtpStartEnd.Value = DateTime.Now.AddHours(-2);
            }
            catch (Exception ex)
            {
        ...
        private void LoadData()
        {
            ...
            System.Data.DataTable dt = TestParaService.instnce.GetAllRecordToTable(dateFrom, dateTo);
